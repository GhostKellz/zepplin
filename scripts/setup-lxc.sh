...
#
# Usage Examples:
#   ./scripts/setup-lxc.sh                                    # Default: ID=100, DHCP
#   ./scripts/setup-lxc.sh 101 zepplin-prod                   # Custom ID and name
#   ./scripts/setup-lxc.sh 102 zepplin-dev vmbr1             # Custom bridge
#   ./scripts/setup-lxc.sh 103 zepplin-test vmbr0 dhcp 9080  # Custom port
#   ./scripts/setup-lxc.sh 104 zepplin-static vmbr0 "192.168.1.100/24,gw=192.168.1.1" 8080
#
# Arguments:
