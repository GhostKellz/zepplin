...
- [ ] Azure AD App Registration completed ([oidc.md](../authentication/oidc.md))
- [ ] GitHub OAuth App created (optional - [github-oauth.md](../authentication/github-oauth.md))
...
- [OIDC / OAuth Setup Guide](../authentication/oidc.md)
- [GitHub OAuth Setup Guide](../authentication/github-oauth.md)